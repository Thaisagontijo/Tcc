...
//Pegando o id do Produto
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSelecionaOpcaoRelatorioCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmSelecionaOpcaoRelatorioCaixa dialog = new frmSelecionaOpcaoRelatorioCaixa(new javax.swing.JFrame(), true);
