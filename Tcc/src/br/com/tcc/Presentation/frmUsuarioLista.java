 ...
 * @author Thaisa
 */
public class frmUsuarioLista extends javax.swing.JDialog {

    /**
     * Creates new form frmCadastroServicosLista
     */
    public frmUsuarioLista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    protected void preencheTabela(){
        ...
        model.addColumn("NOME FUNCIONÁRIO");
        ...
        for(Usuario p : lista){
            ...
            v.add(0,p.getId());
            v.add(1,p.getNome());
            v.add(2,p.getFuncionario().getNome());
    ...
    private void initComponents() {
        ...
        painelServicosCadastrados.setBorder(javax.swing.BorderFactory.createTitledBorder("Usuarios Cadastrados"));
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if(objSelecionadoNaTabela != null){
          frmCadastroUsuario janela = new frmCadastroUsuario(null, rootPaneCheckingEnabled, this, false);
    ...
    protected Usuario objSelecionadoNaTabela;
